...
import {setGroups,SetRightsForm,setChanels} from '../../redux/groupsReduser'
...
export default connect(mapStateToProps, {setGroups,SetRightsForm,setChanels})(withRouter(ChatsContainer));